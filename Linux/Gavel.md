...
![Pasted image 20251203120929](../Attachments/Pasted%20image%2020251203120929.png)

## Login page
![Pasted image 20251203121000](../Attachments/Pasted%20image%2020251203121000.png)

## Register
![Pasted image 20251203121022](../Attachments/Pasted%20image%2020251203121022.png)


## Login with `test1:testtest`
- There is now inventory and bidding
  ![Pasted image 20251203121112](../Attachments/Pasted%20image%2020251203121112.png)
- I find a git folder
- grab it using git dumper
```
git-dumper http://gavel.htb git 
```
![Pasted image 20251203121158](../Attachments/Pasted%20image%2020251203121158.png)
- Looking at `inventory.php` I see there is an SQli
![Pasted image 20251203121404](../Attachments/Pasted%20image%2020251203121404.png)
...
- Table names
![Pasted image 20251202192906](../Attachments/Pasted%20image%2020251202192906.png)
...
- Database name
![Pasted image 20251202193147](../Attachments/Pasted%20image%2020251202193147.png)
...
```
![Pasted image 20251202200022](../Attachments/Pasted%20image%2020251202200022.png)
...
![Pasted image 20251203130101](../Attachments/Pasted%20image%2020251203130101.png)
...
![Pasted image 20251203130446](../Attachments/Pasted%20image%2020251203130446.png)

![Pasted image 20251203130417](../Attachments/Pasted%20image%2020251203130417.png)

- I grab a shell and make it better:
![Pasted image 20251203130525](../Attachments/Pasted%20image%2020251203130525.png)

- Looking for users i find user `auctioneer` which i can change to with it's password we cracked:
![Pasted image 20251203130644](../Attachments/Pasted%20image%2020251203130644.png)

- I grab user flag:
![Pasted image 20251203133334](../Attachments/Pasted%20image%2020251203133334.png)

- Checking it's `id` I see it is part of an unusual group:
![Pasted image 20251203130740](../Attachments/Pasted%20image%2020251203130740.png)
...
![Pasted image 20251203131019](../Attachments/Pasted%20image%2020251203131019.png)
- `/usr/local/bin` has a `gavel-util` executable. It is owned by root and this group we are a part of. 
![Pasted image 20251203131106](../Attachments/Pasted%20image%2020251203131106.png)
...
![Pasted image 20251203131409](../Attachments/Pasted%20image%2020251203131409.png)
...
![Pasted image 20251203131943](../Attachments/Pasted%20image%2020251203131943.png)
```
...
```
![Pasted image 20251203132622](../Attachments/Pasted%20image%2020251203132622.png)


- I check `php.ini`
![Pasted image 20251203132719](../Attachments/Pasted%20image%2020251203132719.png)
...
![Pasted image 20251203133203](../Attachments/Pasted%20image%2020251203133203.png)

![Pasted image 20251203133222](../Attachments/Pasted%20image%2020251203133222.png)

- grab root flag:
![Pasted image 20251203133410](../Attachments/Pasted%20image%2020251203133410.png)
